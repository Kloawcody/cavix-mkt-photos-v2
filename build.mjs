...
const base = (process.env.PACK_SOURCE || "https://temporary-speedy-nova-jma4qk4.vercel.app") + "?v=2";
const root = (process.env.PACK_SOURCE || "https://temporary-speedy-nova-jma4qk4.vercel.app");
...
fs.writeFileSync("index.html", "<!DOCTYPE html><html><head><meta charset=utf-8><title>Cavix</title><link rel=stylesheet href=gallery.css></head><body><div class=brand>CAVIX</div><a href=cavix-marketing-20-photos.zip>ZIP</a></body></html>");
